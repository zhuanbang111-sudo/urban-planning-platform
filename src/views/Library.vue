  ...
  <div class="space-y-6">
    ...
    <div v-else class="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm">
      <div class="relative">
        ...
        >
          <!-- 节点圆点 -->
          <div class="absolute left-[76px] top-1.5 w-2.5 h-2.5 rounded-full bg-green-600 z-10"></div>
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="flex gap-2">
              <button 
                ...
                class="px-3 py-1.5 bg-green-50 hover:bg-green-100 text-green-950 font-medium text-xs rounded-lg transition-colors border border-green-200"
              >
              ...
              <button 
                ...
                class="px-3 py-1.5 bg-green-800 hover:bg-green-700 text-white font-medium text-xs rounded-lg transition-colors"
              >
